...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddContent(this IServiceCollection services, string name,
        Action<ContentBuilder> sourceBuilder)
    {
        if (sourceBuilder is null)
            throw new ArgumentNullException(nameof(sourceBuilder));
        ...
        contentSet.Sources.AddRange(builder);

        services.AddKeyedSingleton<IContentSet>(name, contentSet);

        return services;
    }

    public static IServiceCollection AddContent<TContentSet>(this IServiceCollection services, string name,
        Action<ContentBuilder> sourceBuilder)
    ...
    public static IServiceCollection AddContent<TContentSetContract, TContentSet>(this IServiceCollection services,
        string name, Action<ContentBuilder> sourceBuilder)
        ...
        where TContentSet : ContentSet, TContentSetContract, new()
    {
        ...
        services.AddKeyedSingleton<TContentSetContract>(name, contentSet);
        ...
        where TContentSet : ContentSet, new()
    {
        ...
        services.AddContent<TContentSet>(typeof(TContentSet).FullName, builder => builder
        ...
        where TContentSet : ContentSet, new()
    {
        ...
        services.AddContent<TContentSet>(typeof(TContentSet).FullName, builder => builder
            .From.FilesIn(baseDirectory, FileOptions(fileExtension))
            .ThenFrom.ResourcesIn(typeof(TContentSet).Assembly, ResourceOptions(fileExtension, rootNamespace)));
    ...
    private static ResourceContentSourceOptions ResourceOptions(string fileExtension, string rootNamespace)
    {
        return new ResourceContentSourceOptions
        {
